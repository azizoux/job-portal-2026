...
const ViewApplications = () => {
  ...
  const fetchCompanyJobApplications = async () => {
    try {
      ...
      console.log("Erreur dans ViewApplications:", error.message);
    }
  };
  ...
  const changeJobApplicationStatus = async (id, status) => {
    try {
      ...
      console.log("changeJobApplicationStatus:", error.message);
    }
  };
  useEffect(() => {
    if (companyToken) {
                  ...
                  <tr key={index} className="text-gray-700">
                    ...
                    <td className="py-2 px-4 border-b border-gray-200 relative">
                      {applicant.status === "Pending" ? (
                        ...
                        <span
                          className={`${applicant.status === "Accepted" ? "bg-green-100" : applicant.status === "Rejected" ? "bg-red-100" : "bg-blue-100"} px-4 py-1.5 rounded`}
                        >
                          {applicant.status}
                        </span>
                      )}
